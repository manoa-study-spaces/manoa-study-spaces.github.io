...
* Create an account to post their study spaces - Create up to 5 per week
* Handy button to show interest in a stedy space - Too many people in a room? Now you know!
* Content moderation to delete any questionable postings - No hateful gatherings or extreme trolling (for obvious reasons)
* Search for study locations based on their needs - quiet, empty, outdoors
* Profiles to display their current semester classes - “Wait, you’re in my class?”
* 
## User Guide
...
The landing page is presented to users when they visit the top-level URL to the site. Our landing page shows the current day’s study spaces. If you’re new to the site, it’s an easy way to find new people right away.
